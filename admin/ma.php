...
$query = mysqli_query($conn, "select un,fn,email,ip from user group by ip");
...
// Display search result
        ...
        echo "<table style=\"font-family:arial;width:100%;color:#333333;\">";  
                ...
                <td style=\"border-style:solid;border-width:1px;border-color:#98bf21;background:#98bf21;\">Ip</td>
                <td style=\"border-style:solid;border-width:1px;border-color:#98bf21;background:#98bf21;\">User Name</td>
